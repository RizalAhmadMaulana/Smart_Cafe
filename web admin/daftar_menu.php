              ...
              <div class="card brder-dark" style="border-radius: 10px">
                ...
                <div class="card-body">
                  ...
                  <label style="margin-left: 50px;">
                    <a href="edit_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-success btn-sm">EDIT</a>&nbsp;
                    <a href="hapus_menu.php?id_menu=<?php echo $result['id_menu']  ?>" class="btn btn-danger btn-sm text-light">HAPUS</a>
                  </label>
                </div>
              </div>
            </div>
