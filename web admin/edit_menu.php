...
<html lang="en">
  <head>
    ...
    <title>Smart Cafe | Edit Menu</title>
    <!--Logo Title-->
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right" style="color: #c8c8c8">
                  ...
                  <li class="breadcrumb-item"><a href="daftar_menu.php" style="color: #e2e2e2">&nbsp;&nbsp;Rekap Menu</a></li>
                </ol>
              </div>
              <!-- /.col -->
            </div>
              ...
              <form method="post" action="edit.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="kode_menu" required autocomplete="off" value="<?php echo $result[0]['kode_menu'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nama Makanan :</label>
                    <input type="text" class="form-control" name="nama" required autocomplete="off" value="<?php echo $result[0]['nama'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Harga :</label>
                    <input type="text" class="form-control" name="harga" required autocomplete="off" value="<?php echo $result[0]['harga'] ?>">
                  </div>
                  <div class="form-group">
                    <label for="gambar">Gambar :</label>
                    <input type="file" class="form-control-file border" id="gambar" name="gambar" required autocomplete="off">
                  </div>
                  <div class="form-group">
